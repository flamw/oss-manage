	...
	<div class="main-content" style="overflow: auto">
		...
		<div class="page-content">
			...
			<form class="form-horizontal" id="userinfoForm" method="post"
				action="${ctx}/login/resetPassword">
				...
				<div class="form-group">
					...
					<div class="clearfix  col-sm-6">
						<input type="password" name="rePassword" id="rePassword" size="42"
							placeholder="请确认密码" />
					</div>
	...
	<script>
      if ($('#operate-message').val() != null && $('#operate-message').val() != '') {
    	  if($('#operate-flag').val()=='0'){
    		  $.dndcAlert.fail({title:"重置密码失败",text:$('#operate-message').val(),remove_time:6000});
    	  }else{
	      	$.dndcAlert.success({title:"重置密码成功",text:$('#operate-message').val(),remove_time:4000});
    	  }
